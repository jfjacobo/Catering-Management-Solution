            ...
            try
            {
                ...
                if (!context.Customers.Any())
                {
                    context.Customers.AddRange(
                        ...
                        //Adding more customers with valid email adresses
                        new Customer
                        {
                            FirstName = "Juan",
                            LastName = "Jacobo",
                ...
                string[] mealTypes = new string[] { "Breakfast", "Coffee Break(s)", "Lunch", "Dinner", "BBQ", "Pre Dinner Recpt.", "Reception", "Breakfast/AM", "Breakfast/Lunch", "Light Snacks", "Wine", "Host Bar", "Cash Bar", "Brunch", "Reception/Dinner", "Boxed Lunch", "Boxed Breakfast" };
